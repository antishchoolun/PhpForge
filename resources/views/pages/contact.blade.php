...
<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-12">
            <h1 class="text-3xl font-bold mb-4 bg-gradient-to-r from-indigo-500 to-pink-500 bg-clip-text text-transparent">Contact Us</h1>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="space-y-8">
                <div>
                    <h3 class="text-lg font-semibold mb-4">Office Location</h3>
                    <div class="flex items-start gap-3 text-gray-600">
                        ...
                        <div>
                            <p>338 George St, Brisbane City</p>
                            <p>Australia</p>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="space-y-4">
                        <div class="flex items-center gap-3 text-gray-600">
                            ...
                            <span>contact@phpforge.com</span>
                        </div>
                        <div class="flex items-center gap-3 text-gray-600">
                            <svg class="w-6 h-6 text-indigo-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/>
                            </svg>
                            <span>+61 07 3803 6136</span>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="space-y-2 text-gray-600">
                        ...
                        <p class="text-sm text-gray-500 mt-4">All times in Gulf Standard Time (GST)</p>
                    </div>
                </div>
            ...
            <div class="md:col-span-2">
                ...
                <form action="{{ route('contact.send') }}" method="POST" class="bg-white shadow-sm rounded-lg p-6 border border-gray-100">
                    @csrf
