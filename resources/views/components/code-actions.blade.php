...
>
    <button 
        ...
        <span class="absolute hidden group-hover:block bg-gray-900 text-white text-sm px-2 py-1 rounded -top-8 left-1/2 transform -translate-x-1/2 whitespace-nowrap">
